...
Lista de versões estáveis da biblioteca HTTP, mostrando as versões com suporte a null safety, a versão mínima do SDK Dart necessária e a data de publicação de cada uma delas.Também é possível ver as notas de versão para entender o que mudou em cada atualização.
